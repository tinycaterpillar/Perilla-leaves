...
class Net(nn.Module):
    """MLP with 8 hidden(unit 8) layer with ReLU activate function"""
    def __init__(self):
...
model.load_state_dict(torch.load(cur_path + "/weight/66200_weight.pth", map_location=device))
